"""
Defining the basic elements of tropical linear algebra:
tropical arrays (vectors and matrices)
"""
...
class MParray:
    ...
    def __mul__(self, array):
        ...
        if isinstance(array, (float, int)):
            ...
            result = MParray([xi + yi for xi, yi in zip(self.A, array.A)], dtype=self.dtype)
